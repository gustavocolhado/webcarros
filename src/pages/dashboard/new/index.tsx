...
const schema = z.object({
    ...
    whatsapp: z.string().nonempty("O telefone é obrigatório").refine((value) => /^(\d{10,11})$/.test(value), {
            ...
            <div className="w-full bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2 mt-2">
                ...
                >
                    ...
                    <div className="mb-3">
                        ...
                        name="description"
                        id="description"
                        placeholder="Digite a descrição completo sobre o veicúlo"
                        />
